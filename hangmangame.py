...
answers = ['DELHI','ACHIEVEMENT','MUMBAI','EUROPE','PUNJAB','TELEPHONE','AGRA','DIFFICULT','SCIENCE','SUITCASE','COLONY','CITY',
'APPLICATION','TELEVISION','UTTAR PRADESH','UTTRAKHAND','BUTTER','RAJASTHAN','KOTA','GRAVITY','CRAFTING','DIFFERENT','VEGETABLE',
'PRAGYA','SHUBHAM','PARROT','ELEPHANT','CARELESS','MISSISSIPPI','MISOURI','INTERESTING','DRINK','EAT','ENVIRONMENT','REFRIGERATOR',
'ANT','MONKEY','TABLE','COW','BUFFALO','PAKISTAN','CHINA','HUMAN','AUSTRALIA','NEW ZEELAND','PARTY','HISTORY','SRILANKA','PYTHON',
'ALGORITHM','JAPAN','INFORMATION','ENGLISH','HINDI','VALIDATION','SCIENCE','BIRTHDAY','ENGINEER','ANKITA','HARSH','SIDDHARTH',
'BIHAR','MONKEY','GORAKHPUR','JALANDHAR','AMRITSAR','AJAY','INDIA','GLASS','DOCTOR','ANKIT','PROGRAM','QUALITY','SHUBHNIT','BOOK',
'PEN','LUCKNOW','OWL','NOODLES','MARCH','APRIL','MIRROR','FARMER','DATE','JUNE','AUGUST','PARENT','TEACHER','SCHOOL','UNIVERSITY',
'BROADBAND','ASHISH','HANGMAN','ECONOMICS','PRIYA','WHATSAPP','Rhythm','AMBANI','AIRTEL','INSTAGRAM','SPIDERMAN','SHAKTIMAN','GOOD',
'WHEAT','PIZZA','BURGER','HORSE','CANADA','SNACKS','ONLINE','LONDON','TEA','INTERNET','COFFEE','MANGO','FRIENDS','COMPUTER',
'MOBILE','CAMEL','LAPTOP','EXPERIMENT','POLITICS','MOVIE','YASMEEN','PAINTING','VIRATKOHLI','WIRELESS','MSDHONI','CHINA','APPLE',
'GENUINE','DICTIONARY','LETTER','SOUND','WATERMELON''QUARANTINE','KEYBOARD','AUTOMATIC','ACADEMIC','AFRICA','PRESIDENT','CORONA','SLEEP',
'OFFLINE','WHATSAPP','COMEDY','OPTIMAL','MUSIC','STORY','LITERATURE','INDONESIA','LESSON','FACEBOOK','INSTAGRAM','TWITTER','BANK'
]
...
def check(press_button):
    ...
    if chance <= 6:
        ...
        try:
            ...
            hangman_imagelocation = os.path.abspath(f'C:\\hangman_image\\{chance}.png')
...
def main():
    def frames():
        ...
        frame1 = Frame(root, bg="#a020f0")
        frame1.pack()
        left_side = Frame(frame1, bg="#a020f0")
        left_side.pack(side=LEFT, ipadx=128)
        right_side = Frame(frame1, bg="#a020f0")
        right_side.pack(side=LEFT)
        frame2 = Frame(root)
        frame2.pack()
        frame3 = Frame(root, bg="#85D2D0")
        frame3.pack(pady=15)
    ...
    billlogin_btn_image_location = os.path.abspath('C:\\hangman_image\Hangman.png')
    ...
    score = Label(left_side, image=bill_login_image, bg="#a020f0")
    ...
    #  FRAME 2
    hangman_imagelocation = os.path.abspath('C:\\hangman_image\\1.png')
    hangman_image_open = Image.open(hangman_imagelocation)
    hangman_image_resize = hangman_image_open.resize((300, 300))
